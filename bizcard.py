...
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By Deepak Harikrishnan",
                   
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Deeapak Harikrishnan*!"""})
st.markdown(
    """
    <style>
        .streamlit-container {
        ...
        .streamlit-select-container, .streamlit-button {
            font-size: 18px;
            color: #7F4655;
...
st.markdown("<h1 style='text-align: center; color: #7F4655;'>BizCardX: Extracting Business Card Data with OCR</h1>", unsafe_allow_html=True)
...
if selected == "Home":
    ...
    with col1:
        ...
        st.markdown('## :red[OCR :] Optical character recognition-Optical character recognition or optical character reader is the electronic or mechanical conversion of images of typed, handwritten or printed text into machine-encoded text, whether from a scanned document, a photo of a document, a scene photo or from subtitle text superimposed on an image.')
...
if selected == "Upload & Extract":
    ...
    Data = st.file_uploader("upload here",label_visibility="collapsed",type=["png","jpeg","jpg"])
